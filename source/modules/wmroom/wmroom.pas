...
begin
  ...
  begin
    ...
    AResponse.Contents.LoadFromFile('templates/pages/404/room.htm')
  end else
  begin
    ...
    if BadPass then
      ModuleTemplate.FileName := 'templates/pages/error/auth.htm'
    else if IsAuth then
      ModuleTemplate.FileName := 'templates/pages/room.htm'
    else
      ModuleTemplate.FileName := 'templates/pages/error/room.htm';
